  ...
  return (
    <div className="space-y-6 sm:space-y-7 max-w-[1600px] mx-auto pb-12 text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-800 tracking-tight">Customer Directory</h3>
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <div className="relative w-full sm:w-72 md:w-80 min-w-0">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 sm:py-2.5 rounded-xl bg-white border border-slate-200 text-xs sm:text-sm text-slate-800 focus:outline-none focus:border-[#6B1527] shadow-xs"
            />
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse text-xs sm:text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-600 font-bold uppercase tracking-wider text-[11px] sm:text-xs">
                ...
                <th className="py-3 sm:py-4 px-3 sm:px-6">Contact Details</th>
                <th className="py-3 sm:py-4 px-3 sm:px-6">Location</th>
                <th className="py-3 sm:py-4 px-3 sm:px-6">Patron Tier</th>
                <th className="py-3 sm:py-4 px-3 sm:px-6">Orders</th>
                <th className="py-3 sm:py-4 px-3 sm:px-6">Total Spent</th>
                <th className="py-3 sm:py-4 px-3 sm:px-6">Member Since</th>
              </tr>
            </thead>
                  ...
                  <tr key={customer.id || customer._id} className="hover:bg-slate-50/70 transition">
                    <td className="py-3 sm:py-4 px-3 sm:px-6">
                      <div className="flex items-center gap-2.5 sm:gap-3.5">
                        ...
                        <div className="min-w-0 max-w-[130px] sm:max-w-xs">
                          <span className="font-bold text-xs sm:text-sm md:text-base text-slate-800 block truncate">{customer.name}</span>
                          <span className="text-[11px] sm:text-xs text-slate-400 block mt-0.5 truncate">{customer.id}</span>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 sm:py-4 px-3 sm:px-6 text-slate-700 whitespace-nowrap">
                      <div className="flex items-center gap-1.5 text-xs sm:text-sm font-medium text-slate-800">
                        <FiMail className="text-slate-400 text-xs sm:text-sm shrink-0" />
                    ...
                    <td className="py-3 sm:py-4 px-3 sm:px-6 text-slate-700 whitespace-nowrap">
                      <div className="flex items-center gap-1.5 text-xs sm:text-sm">
                        <FiMapPin className="text-slate-400 text-xs sm:text-sm shrink-0" />
                    ...
                    <td className="py-3 sm:py-4 px-3 sm:px-6 font-bold text-xs sm:text-sm md:text-base text-slate-800 whitespace-nowrap">
                      {customer.ordersCount || 1} orders
                    </td>
                    <td className="py-3 sm:py-4 px-3 sm:px-6 font-bold text-xs sm:text-sm md:text-base text-[#8B1C2C] whitespace-nowrap">
                      ₹{Number(customer.totalSpent || 0).toLocaleString("en-IN")}
                    </td>
                    <td className="py-3 sm:py-4 px-3 sm:px-6 text-xs sm:text-sm text-slate-500 font-medium whitespace-nowrap">{customer.joined || "Jan 2025"}</td>
                  </tr>
                ))
              )}
            </tbody>
