      ...
      <div className="max-w-[1600px] mx-auto px-5">
        ...
        <div className="seller mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 justify-center items-center">
          ...
          {sarees.slice(0, 5).map((saree, index) => (
            <FadeUp key={saree.id || index} delay={0.1 + index * 0.08} className="h-full">
              <div
                className="group shadow rounded-b-lg relative overflow-hidden border border-gray-200 bg-white transition rounded-t-lg h-full flex flex-col justify-between"
              >
                {/* Image + Hover Overlay */}
