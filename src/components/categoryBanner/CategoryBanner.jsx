  ...
  return (
    <div className='bg-[#FEFAF8] py-10'>
        <div className='lg:px-10 px-4 flex flex-col md:flex-row gap-5'>
            ...
            {/* banner-1 */}
            <div className='bg-[url(/images/category-banner1.png)] h-62.5 sm:h-75 md:h-87.5 lg:h-100 w-full 
            ...
            {/* banner-2 */}
            <div className='bg-[url(/images/category-banner2.png)] h-62.5 sm:h-75 md:h-87.5 lg:h-100 
